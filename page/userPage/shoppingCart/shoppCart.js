...
window.accountAndPermissons = function accountAndPermissons() {
  window.location.href = `../accountAndPermissions/accountAndPermissions.html${postCartIDToParam(
    userLogedIn.cartID
  )}`;
};

window.productsManager = function productsManager() {
  window.location.href = `../../adminPage/managerPage/producctManager/productManager.html${postCartIDToParam(
    userLogedIn.cartID
  )}`;
};
window.accountsManager = function accountsManager() {
  window.location.href = `../../adminPage/managerPage/accountManager/accountManager.html${postCartIDToParam(
    userLogedIn.cartID
  )}`;
};
window.voucherManager = function voucherManager() {
  window.location.href = `../../adminPage/managerPage/voucherManager/voucherManager.html${postCartIDToParam(
    userLogedIn.cartID
  )}`;
};
...
async function addToCart(
  ...
  try {
    ...
    if (
      ...
      const updatedCart = await addProductToCartId(
        getUserIDInParam,
        userLogedIn
      );
      if (updatedCart) {
...
window.orderHistory = function orderHistory() {
  window.location.href = `../orderHistory/orderHistory.html${postCartIDToParam(
    userLogedIn.cartID
  )}`;
};

window.viewCart = function viewCart() {
  window.location.href = `../viewCart/viewCart.html${postCartIDToParam(
    userLogedIn.cartID
  )}`;
};
...
window.roleAccessManager = function roleAccessManager() {
  window.location.href = `../../adminPage/managerPage/roleAccessPage/roleAccessPage.html${postCartIDToParam(
    userLogedIn.cartID
  )}`;
};
